...
import com.example.demo.org.csource.fastdfs.*;
...
public class demo {
	...
	public void download(String group, String name) throws IOException, MyException {
		...
		// 7、创建本地文件路径
		String filePath = "/Users/aichaellee/Desktop/cnki-fw";
		...
		IOUtils.write(b, new FileOutputStream(filePath + "/" + UUID.randomUUID().toString() + ".sql"));
